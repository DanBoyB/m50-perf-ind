...
A dataframe is created defining all day types between 2012 and 2019
...
Text descriptions for each day types are defined and data is output to a csv file.
...
dayTypes1219 %>% 
  left_join(dtDesc) %>% 
  write_csv("output/dayTypes1219.csv")
```
